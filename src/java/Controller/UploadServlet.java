...
public class UploadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        fileuser = l.getLoginID();
        String UPLOAD_DIRECTORY = fileuser;
            ...
            if (formItems != null && formItems.size() > 0) {
                ...
                for (FileItem item : formItems) {
                    ...
                    if (!item.isFormField()) {
                        ...
                        file.setOwner(fileuser);
                        file.setSize(fileSize);
                        
                        System.out.println("test_upload 01:" + fileName + " " + filePath + " " + fileuser);
                        ...
                        fdao.createFile(file);
                        System.out.println("test_upload:" + fileName + " " + filePath + " " + fileuser);
                        
                        request.setAttribute("message",
                            "Upload has been done successfully!File Uploaded: ");
                        request.setAttribute("filename",file.getFilename());
                        
                        ArrayList<Files> addlist = new ArrayList<Files>();
                        addlist = (ArrayList<Files>) fdao.getFiles(fileuser);
                        
                        ArrayList<Files> addlist1 = new ArrayList<Files>();
                        addlist1 = (ArrayList<Files>) fdao.getShareFiles(fileuser);
